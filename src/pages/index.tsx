...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`CouseMaker`}</title>

        <meta
          name="description"
          content="Unlock your learning potential with CourseMaker - a comprehensive platform for course creation, registration, and access. Experience seamless payment integration and exclusive content, all in one place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock your learning potential with CourseMaker - a comprehensive platform for course creation, registration, and access. Experience seamless payment integration and exclusive content, all in one place.`}
            </Text>
            <Box
